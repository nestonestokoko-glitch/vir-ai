...
const Navbar1 = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center w-full py-6 px-4">
      <div className="flex items-center justify-between px-6 py-3 bg-white/40 backdrop-blur-md border border-white/30 rounded-full shadow-lg w-full max-w-3xl relative z-10">
        <div className="flex items-center">
          <span className="text-black font-bold text-3xl tracking-tight uppercase">VIR AI</span>
        </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed inset-0 bg-white/70 backdrop-blur-xl z-50 pt-24 px-6 md:hidden"
